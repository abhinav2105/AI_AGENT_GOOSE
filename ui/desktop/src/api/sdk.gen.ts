...
export const getSessionTags = <ThrowOnError extends boolean = false>(options: Options<GetSessionTagsData, ThrowOnError>) => (options.client ?? client).get<GetSessionTagsResponses, GetSessionTagsErrors, ThrowOnError>({ url: '/sessions/{session_id}/tags', ...options });

export const addSessionTags = <ThrowOnError extends boolean = false>(options: Options<AddSessionTagsData, ThrowOnError>) => (options.client ?? client).put<AddSessionTagsResponses, AddSessionTagsErrors, ThrowOnError>({
...
export const autoTagSession = <ThrowOnError extends boolean = false>(options: Options<AutoTagSessionData, ThrowOnError>) => (options.client ?? client).post<AutoTagSessionResponses, AutoTagSessionErrors, ThrowOnError>({ url: '/sessions/{session_id}/tags/auto', ...options });

export const removeSessionTag = <ThrowOnError extends boolean = false>(options: Options<RemoveSessionTagData, ThrowOnError>) => (options.client ?? client).delete<RemoveSessionTagResponses, RemoveSessionTagErrors, ThrowOnError>({ url: '/sessions/{session_id}/tags/{tag}', ...options });
