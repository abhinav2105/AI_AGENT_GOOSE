...
#[openapi(
    paths(
        ...
        super::routes::session::get_session_tags,
        super::routes::session::add_session_tags,
        super::routes::session::remove_session_tag,
        super::routes::session::get_all_tags,
        super::routes::session::auto_tag_session,
    ...
    components(schemas(
        ...
        super::routes::session::SessionTagsResponse,
        super::routes::session::AddTagsRequest,
        super::routes::session::AllTagsResponse,
        goose::session::session_manager::SessionTag,
        goose::session::session_manager::TagCount,
        Message,
        MessageContent,
        MessageMetadata,
        TokenState,
